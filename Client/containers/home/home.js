...
const home = {
  render: async () => {
    ...
    const headerComponent = await header.render([{ name: 'Create account', path: '/signup' }, { name: 'Sign in', path: '/signin' }], ['navigation__link', 'navigation__link-with-border'], '-transparentBg');
